...
class VNDBConnection:
    ...
    def __init__(self):
        ...
        """
        self.clientvars = {'protocol': 1, 'clientver': 2.0, 'client': 'Pymoe'}
        self.loggedin = False
    ...
    def login(self):
        ...
        :return: Nothing
        :raises: :class:`Pymoe.errors.GeneralLoginError` - For some reason, logging in without authentication failed
        """
